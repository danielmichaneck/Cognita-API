...
namespace Cognita_API.Controllers
{
    ...
    public class CourseController : ControllerBase
    {
        ...
        [SwaggerOperation(Summary = "Get all courses", Description = "Get all available courses", OperationId = "GetAllCourses")]
        ...
        [SwaggerOperation(Summary = "Get a course by id", Description = "Get a course by id", OperationId = "GetCourseById")]
        ...
        [SwaggerOperation(Summary = "Edit a course by id", Description = "Edit a course by id", OperationId = "EditCourseById")]
        ...
        [SwaggerOperation(Summary = "Create a new course", Description = "Create a new course", OperationId = "CreateMovie")]
        ...
        public async Task<ActionResult<CourseDto>> PostCourse(CourseForCreationDto dto) {
            ...
            var createdMovie = await _context.Courses.Include(m => m.Director).FirstOrDefaultAsync(m => m.Id == course.Id);
            var courseDTO = mapper.Map<MovieDto>(createdMovie);*/
